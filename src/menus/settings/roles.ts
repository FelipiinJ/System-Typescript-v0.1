...
export const settingsRolesOptions = [
    ...
    { emoji: "💬", label: "Membro", value: "member", description: "Cargo de membro" },
] as const;
...
export function settingsRolesMenu(guildData: GuildSchema) {
    ...
    const embed = createEmbed({
        ...
        description: brBuilder(
            `${icon(":a:setawhite")} Configurar cargos`,
            "",
            display
        )
    });
    ...
    const row = createRow(
        new StringSelectMenuBuilder({
            ...
            placeholder: "Seelecione o cargo que deseja",
...
export function settingsRoleMenu(guildData: GuildSchema, selected: string) {
    ...
    const embed = createEmbed({
        ...
        description: brBuilder(
            `${icon(":a:setawhite")} Alterar o cargo ${emoji} ${label}`,
